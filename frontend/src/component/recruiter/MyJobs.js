    ...
    <Paper className={classes.jobTileOuter} elevation={3}>
      <Grid container>
        <Grid container item xs={9} spacing={1} direction="column">
          ...
          <Grid item>Salary : Rp. {job.salary.toLocaleString()} per month</Grid>
          <Grid item>
            Duration :{" "}
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Grid item xs>
            <Typography variant="h6" style={{ color: "white", fontWeight: "bold", fontFamily: 'Nunito Sans, sans-serif',  alignItems: "center"}}>My Jobs</Typography>
          </Grid>
          <Grid item xs>
            <TextField
              label="Search Jobs"
